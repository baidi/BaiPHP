...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo _ISSUE; ?>style/css/user.css" />
	<!--[if lt IE 9]>
	<script type="text/javascript" src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
	<![endif]-->
	<script type="text/javascript" src="<?php echo _ISSUE; ?>style/js/jquery-1.8.0.js"></script>
	...
	<script type="text/javascript" src="<?php echo _ISSUE; ?>style/js/user.js"></script>
</head>
<body>
	<header><!-- 页首 -->
		<div class="box logo">BaiCode - 简单开发</div>
		<nav class="box">
			<?php
	...
	<footer><!-- 页脚 -->
		...
		<div class="box tr">
			...
			<span>
				...
				<img src="<?php echo _ISSUE; ?>style/img/icon.png"></img> 大乘网络支持中心
			</span>
		</div>
	</footer>
</body>
