...
$config[Lang::LANG][Lang::ZH]['base'] = '流域';
$config[Lang::LANG][Lang::ZH]['base-name'] = '流域名：';
$config[Lang::LANG][Lang::ZH]['base-create'] = '新建流域';
$config[Lang::LANG][Lang::ZH]['base-update'] = '修改流域';
$config[Lang::LANG][Lang::ZH]['base-delete'] = '删除流域';
